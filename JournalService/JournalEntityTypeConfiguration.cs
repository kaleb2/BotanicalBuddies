...
public class JournalEntityTypeConfiguration: IEntityTypeConfiguration<Journal>
{
    public void Configure(EntityTypeBuilder<Journal> builder)
    {
        ...
        builder.HasData(new Journal() {JournalId=3, JournalTitle="Bingo's Palm Journal", UserId=1, PlantId=3, DateCreated=DateTimeOffset.Now});
        Console.WriteLine("Bingo's Palm Journal");
