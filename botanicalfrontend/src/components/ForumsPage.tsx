        ...
        <div className="threads container">
          ...
          {threadCreation ? (
            <>   
              ...
              <button type="button" style={{marginTop: "10px"}} className="btn btn-primary" onClick={closeThreadCreation}>
                Cancel
              </button>
            </>
          ) : (
            <>     
              <button type="button" style={{marginTop: "10px"}} className="btn btn-primary" onClick={openThreadCreation}>
                Create a new thread
              </button>
            </>
          )
...
export const CreateThreadForm = ({ handleInputChange, createThread, thread }) => {
  return (
    ...
    <form>
      ...
      <button type="button" style={{marginTop: "10px"}} className="btn btn-primary" onClick={createThread}>
        Create a Thread
      </button>
    </form></>
  )
