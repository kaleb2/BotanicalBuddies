        ...
        <div className="threadContainer">
            ...
            <div>
                {postCreation ? (
                    ...
                    <button type="button" style={{marginTop: "10px", backgroundColor: "green", border: "black"}} className="btn btn-primary" onClick={closePostCreation}>
                        Cancel
                    </button>
                    </>
                ) : (
                    <>     
                    <button type="button" style={{marginTop: "10px", backgroundColor: "green", border: "black"}} className="btn btn-primary" onClick={openPostCreation}>
                        Create a new post
                    </button>
                    </>
                )
...
export const CreatePostForm = ({ handleInputChange, createPost, post }) => {
    return (
      ...
      <form>
        ...
        <button type="button" style={{marginTop: "10px", backgroundColor: "green", border: "black"}} className="btn btn-primary" onClick={createPost}>
          Create a Post
        </button>
      </form></>
    )
